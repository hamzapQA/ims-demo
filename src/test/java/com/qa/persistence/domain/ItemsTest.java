...
public class ItemsTest {
	...
	@Before
	public void setUp() {
		item = new Items(1L, "iphone", 2.75, 100);
		other = new Items(1L, "iphone", 2.75, 100);
	...
	public void constructorWithoutId() {
		Items item = new Items("samsung", 4.99, 10);
		assertNull(item.getItem_id());
		assertNotNull(item.getItemName());
		assertNotNull(item.getPrice());
		assertNotNull(item.getStock());
	...
	public void toStringTest() {
		String toString = "Item Id: 1, Item Name: iphone, price: 2.75, stock: 100";
